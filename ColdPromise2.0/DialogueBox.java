...
public class DialogueBox extends Actor
{
    ...
    private float nameSize = 20.0f;
    /** The font size of the dialogue text. */
    private float textSize = 20.0f;
    /** The font size of the "press enter" text. */
    private float instrSize = 12.0f;
    /** Width of the box. */
    private int width = 650;
    /** Height of the box. */
    public int height = 200;
    /** Delay time between box changes. */
    private int boxDelay = 10;
    /** Elapsed delay time between box changes. */
    private int boxDelCount = 0;

    /** Name of NPC with whom the player speaks. */
    private String name;
    /** Number in chat sequence. */
    private int chatNum;

    public DialogueBox(String npcName, int number) {
        this.name = npcName;
        chatNum = number;
        chat();
    }
    ...
    private void update(String name, String dialogue1, String dialogue2, String dialogue3) {
        ...
        image.setColor(new Color(100, 100, 255, 128));
        ...
        image.drawString(dialogue1, 30, 80);
        image.drawString(dialogue2, 30, 105);
        image.drawString(dialogue3, 30, 130);
    ...
    /** Checks if player has indicated to move on. */
